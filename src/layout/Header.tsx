...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between w-full px-6 sticky top-0 bg-zinc-50 text-xs lg:rounded-lg dark:bg-zinc-900 neu-card-mini">
      <Link to="/" className="h-12 flex items-center text-2xl font-bold">
        IsMe
      </Link>
